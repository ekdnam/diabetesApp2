        ...
        return (
            <TouchableHighlight
                ...
                <View style={rowContainerStyle}>
                    {props.subtitle != null ? (
                        <View>
                            <Text style={styles.rowTitleStyleWithSubTitle}>
                                {props.title}
                            </Text>
                            <Text style={styles.rowSubTitleStyle}>
                                {props.subtitle}
                            </Text>
                        </View>
                    ) : (
...
const BooleanSettingsRow = (props: {
    title: string;
    value: boolean;
    ...
    return (
        <View style={styles.rowContainerStyleNormalPadding}>
            <Text style={styles.rowTitleStyle}>{props.title}</Text>
            <Switch
...
const ServiceQuotaMeter = React.memo((props: { serviceKey: string }) => {
    ...
    const service = useMemo(
        () => DataServiceManager.instance.getServiceByKey(props.serviceKey),
        [props.serviceKey],
    );
            ...
            <View style={styles.rowContainerStyleNormalPadding}>
                ...
                {quotaResetAt >= Date.now() ? (
                    <Text style={styles.smallTextStyle}>
                        {leftQuota} Calls left (refilled at{' '}
                        {format(quotaResetAt, 'h:mm a')}).
                    </Text>
                ) : (
...
class SettingsScreen extends React.PureComponent<Props, State> {
    ...
    readonly onPressUnitRow = () => {
        ...
        if (Platform.OS === 'ios') {
            ...
            UIManager.showPopupMenu(
                findNodeHandle(this.unitRowRef.current as any),
                selections,
                () => { },
                (item, buttonIndex) => {
                    this.props.setUnitType(buttonIndex);
            ...
            [
                {
                    ...
                    onPress: async () => {
                        ...
                        await DataServiceManager.instance
    ...
    readonly onSetRecordLogs = (recordLogs: boolean) => {
        if (
                ...
                [
                    ...
                    },
                    {
                        ...
                        onPress: () => {
                            ...
                            this.props.setRecordLogs(
                                true,
                                this.props.loggingSessionId,
                            );
                        },
                    },
                    {
            ...
            this.props.setRecordLogs(recordLogs, this.props.loggingSessionId);
    };

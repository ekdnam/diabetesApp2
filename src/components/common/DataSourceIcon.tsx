...
export const DataSourceIcon = (props: { type: DataSourceType, color: string, size?: number, style?: ViewStyle }) => {
    ...
    switch (props.type) {
        case DataSourceType.Weight:
            return <Svg style={props.style} width={size} height={size} viewBox="0 0 48.94 48.94">
        ...
        case DataSourceType.HeartRate:
            return <Svg style={props.style} width={size} height={size} viewBox="0 0 52.91 48.54">
        ...
        case DataSourceType.HoursSlept:
            return <Svg style={props.style} width={size} height={size} viewBox="0 0 57.96 47.2">
